      ...
      <div className="max-w-4xl mx-auto px-6 text-center">
        ...
        <div className="mb-16">
          <h2 className="text-3xl md:text-5xl font-medium tracking-tight text-white mb-6">
            Tarification <span className="font-playfair italic text-neutral-400">Sur Mesure</span>
          </h2>
          <p className="text-neutral-400 text-lg mb-8 max-w-2xl mx-auto">
            Parce que chaque entreprise a des besoins uniques, nous construisons nos offres en fonction de vos projets et de vos ambitions. Pas de grille rigide, uniquement de la valeur ajoutée.
          </p>
        </div>
        ...
        <div className="p-8 md:p-12 rounded-3xl bg-[#0a0a0a] border border-white/10 shadow-[0_0_50px_-20px_rgba(0,250,154,0.1)] relative overflow-hidden animate-reveal">
            ...
            <div className="relative z-10 flex flex-col items-center">
                <h3 className="font-playfair italic text-3xl text-white mb-6">Parlons de votre projet</h3>
                <p className="text-neutral-500 mb-10 max-w-lg text-center">
                    Discutons de vos objectifs pour établir une proposition adaptée à votre budget et à vos délais.
                </p>
