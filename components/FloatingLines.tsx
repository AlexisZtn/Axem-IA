...
export default function FloatingLines({
  ...
  useEffect(() => {
    ...
    if (interactive) {
      ...
      renderer.domElement.addEventListener('pointerleave', handlePointerLeave as any);
    }
    ...
    return () => {
      ...
      if (interactive) {
        ...
        renderer.domElement.removeEventListener('pointerleave', handlePointerLeave as any);
      }
